...
Based on organic earth tones with green undertones:

#### Dark Mode (theme-value: 0)
| Variable | Value | Description |
|----------|-------|-------------|
| `--bg-primary` | #0a0f0a | Deep forest black |
| `--bg-surface` | #121812 | Moss surface |
| `--bg-card` | rgba(20, 28, 20, 0.85) | Forest glass |
| `--text-primary` | #e8f0e8 | Soft white-green |
| `--text-secondary` | #a8b8a8 | Sage gray |
| `--accent-primary` | #4ade80 | Living green |
| `--accent-secondary` | #22d3ee | Clear water |

#### Light Mode (theme-value: 1)
| Variable | Value | Description |
|----------|-------|-------------|
| `--bg-primary` | #f5f7f5 | Cloud white |
| `--bg-surface` | #e8ece8 | Morning mist |
| `--bg-card` | rgba(255, 255, 255, 0.85) | Light glass |
| `--text-primary` | #1a1f1a | Deep earth |
| `--text-secondary` | #4a524a | Stone gray |
| `--accent-primary` | #16a34a | Forest green |
| `--accent-secondary` | #0891b2 | Deep water |
...
- System health ring charts
- Quick action buttons
- Live activity feed

#### 2. Hardware Control
- GPU monitoring with real-time graphs
